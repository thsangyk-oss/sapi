        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install SAPI, configure your providers via web dashboard, and start routing AI API requests.
            </p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg">Install SAPI</h4>
                  <p className="text-sm text-gray-500 mt-1">Run the launcher command to start the server</p>
                </div>
              </div>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#0f172a] border border-[#1e3a5f] shadow-2xl">
              {/* Terminal header */}
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("start-sapi.cmd")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">start-sapi.cmd</span>
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#22d3ee]">&gt;</span> Starting SAPI...<br/>
                  <span className="text-[#22d3ee]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:20128</span><br/>
                  <span className="text-[#22d3ee]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:20128/dashboard</span><br/>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  macOS/Linux:</span> ~/.sapi/db.json<br/>
                  <span className="text-gray-500">  Windows:</span> %APPDATA%/sapi/db.json
                </div>
              </div>
            </div>
          </div>
