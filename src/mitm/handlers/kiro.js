 ...
 * If SAPI's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
...
/**
 * Read SAPI's OpenAI SSE response and re-encode it as AWS EventStream binary
      ...
      for (const line of lines) {
        ...
        if (delta.tool_calls) {
          ...
          for (const tc of delta.tool_calls) {
            ...
            // when SAPI's Anthropic→OpenAI conversion passes a pre-parsed object
 ...
 *   3. Forward to SAPI /v1/chat/completions (OpenAI SSE)
